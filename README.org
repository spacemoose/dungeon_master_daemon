...
*** TODO test_instances
- [ ] kinda gotta decide on a basic interface for creating and adding instances.
- [ ] on construction, I want to roll the hit points, and initiative.  Options can come later.
